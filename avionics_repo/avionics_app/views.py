...
import sys
import os
from .functions.functions import handle_uploaded_file,convert_to_24_h
    ...
    if request.method == 'POST':
        try:
            ...
            if "already exists" in str(e):
                return HttpResponse("process already exists")
            else:
                return HttpResponse("Failed to create process")
    projects=process_file_repo.objects.all()
    context = {"projects":  projects}
    return render(request, 'index.html', context)
